...
import { 
    ...
    FaFileAlt, FaLock, FaCheckCircle, FaStar,
    FaArrowRight, FaGavel, FaBriefcase, FaUserTie
} from 'react-icons/fa';
    ...
    const features = [
        {
            ...
            description: "Organize and track all your legal cases in one centralized platform with real-time updates.",
            color: "from-blue-500 to-blue-600"
        },
        {
            icon: <FaFileAlt className="text-4xl" />,
            title: "Document Management",
            description: "Securely store, organize, and access all case documents with advanced search capabilities.",
            color: "from-purple-500 to-purple-600"
        },
        {
            icon: <FaUsers className="text-4xl" />,
            title: "Client Portal",
            description: "Give clients 24/7 access to their case information and communicate seamlessly.",
            color: "from-green-500 to-green-600"
        },
        {
            icon: <FaClock className="text-4xl" />,
            title: "Time Tracking",
            description: "Accurately track billable hours and generate detailed reports for transparent billing.",
            color: "from-yellow-500 to-yellow-600"
        },
        {
            icon: <FaChartLine className="text-4xl" />,
            title: "Analytics & Reports",
            description: "Gain insights with comprehensive analytics and customizable reports on your practice.",
    ...
    const testimonials = [
        {
            ...
            content: "AdvoDesk has transformed how we manage our cases. The efficiency gains are remarkable, and our clients love the transparency.",
            rating: 5,
            avatar: "SJ"
        },
        {
            ...
            content: "As a solo lawyer, AdvoDesk gives me the tools of a large firm. It's intuitive, powerful, and has significantly improved my practice.",
            rating: 5,
            avatar: "MC"
        },
        {
            ...
            content: "The security features and compliance tools give us peace of mind. AdvoDesk is an essential part of our legal operations.",
            rating: 5,
            avatar: "ER"
        }
    ];
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            <a href="#features" className="text-gray-700 hover:text-sky-600 font-medium transition-colors">Features</a>
                            <a href="#why-us" className="text-gray-700 hover:text-sky-600 font-medium transition-colors">Why Us</a>
                            <a href="#testimonials" className="text-gray-700 hover:text-sky-600 font-medium transition-colors">Testimonials</a>
                            <button 
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {stats.map((stat, index) => (
                            <div key={index} className="text-center text-white animate-scale-in" style={{animationDelay: `${index * 100}ms`}}>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="#" className="hover:text-sky-400 transition-colors">Compliance</a></li>
                            </ul>
                        </div>
                    </div>
